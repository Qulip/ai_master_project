# 🚀 클라우드 거버넌스 슬라이드 생성 AI

클라우드 거버넌스 관련 질문에 답변하고, 요청 시 슬라이드 형식으로 개념을 요약 생성해주는 AI 서비스입니다.
...
- **슬라이드 생성**: 프레젠테이션용 슬라이드 자동 생성 (JSON/Markdown 형식)
...
- RAG 검색, 슬라이드 포맷팅 등의 전문 도구

### 3. 에이전트 시스템

- **멀티 에이전트 아키텍처**로 역할별 전문화
- MCP 클라이언트를 통한 도구 활용

## 🚀 주요 기능

- **🔍 질문 답변**: 클라우드 거버넌스 관련 전문 지식 제공
- **📊 슬라이드 생성**: 프레젠테이션용 구조화된 슬라이드 자동 생성
